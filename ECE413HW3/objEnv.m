...
%                 obj.envParams.StartPoint=varargin{1};
    ...
    methods(Access = protected)
        function setupImpl(obj)
            ...
            %someWaveform = 2-exp(linspace(obj.envParams.SustainLevel,obj.envParams.FinalLevel,obj.releaseMaxInd));
            %someWaveform = 2-exp(linspace(obj.envParams.FinalLevel,obj.envParams.SustainLevel,obj.releaseMaxInd));
            %someWaveform(someWaveform < 0) = 0;
            %obj.releaseWaveform = someWaveform;
        ...
        function env = stepImpl(obj)
            ...
            elseif any(timeVec < obj.envParams.ReleasePoint)
                ...
                env=[repmat(obj.envParams.SustainLevel,1,obj.releaseInd) obj.releaseWaveform(obj.releaseInd+1+(0:(minLen-1-obj.releaseInd)))];
