...
classdef objNote
    properties
        ...
        instrument = 'Additive'                                             % default synthesis method
    ...
    methods
        function obj = objNote(noteNumber,temperament,startTime,endTime,amplitude,synthMethod)%key,startTime,endTime,amplitude)
            ...
            if nargin >= 6
                ...
                % correct
                switch synthMethod
                    case {'additive', 'Additive', 'subtractive', 'Subtractive', 'fm', 'FM', 'waveshaper', 'Waveshaper'}
                        obj.instrument = synthMethod;
                    otherwise
                        obj.instrument = 'Additive';
                end
